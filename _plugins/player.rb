...
module Jekyll
  class PlayerTag < Liquid::Tag
    ...
    def render(context)
    	url = "https://s3-eu-west-1.amazonaws.com/cdn.pooltund.improv.ee/mp3/" + context.environments.first['page']['mp3']
...
<p><a href="#{url}" class="btn" target="_blank"><i class="fa fa-music"></i> MP3 fail</a></p>
EOS
    end
  end
end
